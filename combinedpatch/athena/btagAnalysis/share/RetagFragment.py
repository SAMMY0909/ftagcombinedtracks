...
if doRetag:
  ...
  def RenameInputContainerCfgExample(suffix, JetCollectionShort, tracksKey = 'InDetCombinedTrackParticles'):
    ...
    ####AddressRemappingSvc.TypeKeyRenameMaps += ['xAOD::TrackParticleAuxContainer#' + InDetCombinedTrackParticles + '.TrackCompatibility->' + tracksKey + '.TrackCompatibility_' + suffix]
